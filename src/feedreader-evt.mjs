...
emitter.on('add', async (url) => {
    if (url === undefined){
        console.log('Please provide the URL with the add command. ');
    } else {
        feeds.push(url);
    }
        prompt();
...
emitter.on('del', async (index) => {
    if (index === undefined){
            console.log('Please provide the index of the URL to delete. ');
} else {
...
emitter.on('read', async (index) => {
    if (index === undefined){
            console.log('Please provide the index of the URL to read. ');
} else {
     index = parseInt(index, 10)
...
//         if (cmdParts.length < 2) {
//             console.log('Please provide the URL to read. ');
//         } else {
